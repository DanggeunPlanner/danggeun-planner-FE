  ...
  return (
    <>
      <p>
        ...
        개인정보 처리방침을 수립·공개합니다
        <br />○ 이 개인정보처리방침은 2023년 2월 9부터 적용됩니다.
        <br />
        제1조(개인정보의 처리 목적)
        <br />
        당근플래너 팀('https://www.dggnplanner.com/'이하 '당근플래너')은(는)
        ...
        <br />
        ① 당근플래너 팀은(는) 법령에 따른 개인정보 보유·이용기간 또는
        ...
        제3조(처리하는 개인정보의 항목)
        <br />
        ① 당근플래너 팀은(는) 다음의 개인정보 항목을 처리하고 있습니다.
        <br />
        1.재화 또는 서비스 제공
        <br />
        필수항목 : 이메일
        ...
        <br />
        ① 당근플래너 팀은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
        ...
        1. 파기절차
        <br />
        당근플래너 팀은(는) 파기 사유가 발생한 개인정보를 선정하고, 당근플래너
        팀의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
        <br />
        2. 파기방법
        <br />
        제5조(정보주체와 법정대리인의 권리·의무 및 그 행사방법에 관한 사항)
        <br />
        ① 정보주체는 당근플래너 팀에 대해 언제든지 개인정보
        열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
        <br />
        ② 제1항에 따른 권리 행사는당근플래너 팀에 대해 「개인정보 보호법」
        시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실
        수 있으며 당근플래너 팀은(는) 이에 대해 지체 없이 조치하겠습니다.
        <br />
        ...
        <br />
        ⑥ 당근플래너 팀은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
        요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한
        대리인인지를 확인합니다. <br />
        제6조(개인정보의 안전성 확보조치에 관한 사항)
        <br />
        당근플래너 팀은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를
        취하고 있습니다.
        <br />
        1. 정기적인 자체 감사 실시
        <br />
        ...
        2. 해킹 등에 대비한 기술적 대책
        <br />
        당근플래너 팀('당근플래너')은 해킹이나 컴퓨터 바이러스 등에 의한
        ...
        사항)
        <br />
        당근플래너 팀 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
        ‘쿠키(cookie)’를 사용하지 않습니다.
        <br />
        제8조 (개인정보 보호책임자에 관한 사항)
        <br />
        ① 당근플래너 팀 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
        ...
        직급 :팀원
        <br />
        연락처 :010-2751-9822, suhjaesuk@gmail.com,
        <br />
        ※ 개인정보 보호 담당부서로 연결됩니다.
        <br />
        ▶ 개인정보 보호 담당부서
        ...
        담당자 :<br />
        연락처 :, ,<br />
        ② 정보주체께서는 당근플래너 팀 의 서비스(또는 사업)을 이용하시면서
        발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
        개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 당근플래너 팀
        ...
        부서에 할 수 있습니다.
        <br />
        당근플래너 팀은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록
        노력하겠습니다.
        <br />
        ▶ 개인정보 열람청구 접수·처리 부서
        <br />
        ...
        제11조(개인정보 처리방침 변경)
        <br />
        ① 이 개인정보처리방침은 2023년 2월 9부터 적용됩니다.
        <br />
